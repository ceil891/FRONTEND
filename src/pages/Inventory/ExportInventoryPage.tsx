...
const mockExports = [
  { no: 1, maPhieu: 'PX260301', ngayXuat: '06/03/2026', lyDo: 'Xuất bán buôn', khachHang: 'Đại lý ABC', tongTien: 45000000, nguoiLap: 'Admin', trangThai: 'Hoàn thành' },
  { no: 2, maPhieu: 'PX260302', ngayXuat: '05/03/2026', lyDo: 'Xuất hủy hàng hỏng', khachHang: '---', tongTien: 1250000, nguoiLap: 'Kho Hà Nội', trangThai: 'Hoàn thành' },
];
      ...
      <Card sx={{ borderRadius: 2, boxShadow: '0 2px 10px rgba(0,0,0,0.05)', border: 'none' }}>
        <CardContent sx={{ p: 0, '&:last-child': { pb: 0 } }}>
          ...
          <Box sx={{ p: 1.5, display: 'flex', flexWrap: 'wrap', gap: 0.5, borderBottom: '1px solid #f1f5f9', alignItems: 'center' }}>
            ...
            />
            <Button size="small" variant="contained" startIcon={<AddIcon />} sx={{ bgcolor: '#00a65a', '&:hover': { bgcolor: '#008d4c' }, textTransform: 'none', borderRadius: 1, boxShadow: 'none' }}>Lập Phiếu Xuất</Button>
            ...
            <Table sx={{ minWidth: 1000 }}>
              <TableHead sx={{ bgcolor: '#ffffff' }}>
                <TableRow>
                  ...
                  {['Mã Phiếu', 'Ngày Xuất', 'Lý Do Xuất', 'Khách Hàng/ĐV Nhận', 'Tổng Giá Trị', 'Người Lập', 'Trạng Thái'].map((col) => (
              ...
              <TableBody>
                {mockExports.map((row) => (
                  <TableRow key={row.no} hover sx={{ '&:last-child td': { border: 0 } }}>
                    ...
                    <TableCell sx={{ borderBottom: '1px solid #f1f5f9', fontSize: '0.85rem', color: '#475569', p: 1.5 }}>{row.ngayXuat}</TableCell>
                    <TableCell sx={{ borderBottom: '1px solid #f1f5f9', fontSize: '0.85rem', color: '#0f172a', fontWeight: 600, p: 1.5 }}>{row.lyDo}</TableCell>
                    <TableCell sx={{ borderBottom: '1px solid #f1f5f9', fontSize: '0.85rem', color: '#475569', p: 1.5 }}>{row.khachHang}</TableCell>
          ...
          <Box sx={{ p: 1.5, bgcolor: '#ffffff', borderTop: '1px solid #f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
             ...
             <Typography variant="body2" color="text.secondary" sx={{ fontWeight: 500 }}>1 - {mockExports.length} of {mockExports.length} items</Typography>
          </Box>
        </CardContent>
      </Card>
    </Box>
